...
#leer el K error
k.error<- read.delim("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/out/admixture/zdiploperennis_Kerror.txt", header = F, sep = ":")
...
##Obtener metadatos
samples_meta<-read.delim("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/data/datosZdiploperennis/PopMap_diploperennis.txt", 
                         header=TRUE, sep="\t")

samples_names<-read.delim("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/data/datosZdiploperennis/bytaxa_diploperennis.fam", header=FALSE, sep=" ") %>%
select(., V2) %>%
rename(., INDIV=V2)

#leer el archivo Q 
Qval<-read.table(paste0("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/out/admixture/bytaxa_diploperennis.5.Q"))
