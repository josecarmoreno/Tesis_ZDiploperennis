...
#leer el K error
k.error<- read.delim("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/R/resultados/admixture/admixtureNa/zdiploperennisNa_Kerror.txt", header = F, sep = ":")
...
##Obtener metadatos
samples_meta<-read.delim("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/R/data/datosZdiploperennis/datosJC/Populations/meta_Nayarit.txt", 
                         header=TRUE, sep="\t")

samples_names<-read.delim("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/R/data/datosZdiploperennis/datosJC/Populations/diploperennis_dataNa.fam", header=FALSE, sep=" ") %>%
  select(., V2) %>%
  rename(., INDIV=V2)

#leer el archivo Q 
Qval<-read.table(paste0("/home/genconser/Documentos/JoseCarlos/DiversidadZdiploperennis/R/resultados/admixture/admixtureNa/diploperennis_dataNa.4.Q"))
